            ...
            try
            {
                ...
                using (var db = new EF.CMCSQL03Entities())
                {
                    ...
                    foreach (var r in q)
                    {
                        ...
                        // min requirements are clientid, productdetailid
        ...
        public static int ImportOrders()
        {
            ...
            using (var db = new EF.CMCSQL03Entities())
            {
                ...
                var qGUIDs = (from t in db.tblOrderImport
                              where t.ImportStatus == "PASS" && t.Location_MDB == "EU"
                ...
                foreach (var r in qGUIDs)
                {
                    ...
                    if (qOM.ImportStatus == "PASS")
                    {
                        NewOrder.orderstatus = null;
                    }
                    else
                    {
                        NewOrder.orderstatus = "X";
                    }
                    // divisionid ??
                    ...
                    //NewOrder.importdateline = Convert.ToDateTime(qOM.ImportDateLine);
                    ...
                    Services.OrderService.fnSaveOrderPostUpdate(NewOrder);
                    ...
                    foreach (var i in qOI)
                    {
                        ...
                        Services.OrderService.fnSaveItemPostUpdate(NewItem);
